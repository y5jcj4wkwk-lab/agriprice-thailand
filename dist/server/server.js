...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-_IFOFXch.js");
...
var manifest = { "dd3738db5a46b2429c9340e602ce6e45072d3289cfb4c666c8f08958eba36d1d": {
	functionName: "getOfficialBoard_createServerFn_handler",
	importer: () => import("./assets/official-feed-ltTCEviS.js")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-DVM26KWM.js").then((n) => n.t),
...
//#endregion
export { createServerEntry, server_default as default, TSS_SERVER_FUNCTION as n, createServerFn as t };
