...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-s5gQRUl-.mjs");
...
var manifest = { "dd3738db5a46b2429c9340e602ce6e45072d3289cfb4c666c8f08958eba36d1d": {
	...
	importer: () => import("./official-feed-4N1j67gK.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DQz3v30J.mjs").then((n) => n.t),
